...
import 'src/elements/CreateStoriesWidget.dart' as storiesRepo;
              ...
              return GetMaterialApp(
                  ...
                  theme: _setting.brightness.value == Brightness.light
                      ? ThemeData(
                          ...
                          hintColor: config.Colors().secondColor(1).withOpacity(1.0),
                          textTheme: TextTheme(
                            headline5: TextStyle(
                                fontSize: 25.0,
                                fontWeight: FontWeight.w700,
                                color: config.Colors().secondColor(1).withOpacity(1.0),
                                height: 1.35),
                            headline4: TextStyle(
                                fontSize: 15.0,
                                fontWeight: FontWeight.w500,
                                color: Theme.of(context).splashColor.withOpacity(1.0),
                                height: 1.35),
                            headline3: TextStyle(
                                fontSize: 15.0,
                                fontWeight: FontWeight.w700,
                            ...
                            headline2: TextStyle(
                                ...
                                color: config.Colors().mainColor(1).withOpacity(1.0),
                                height: 1.35),
                            headline1: TextStyle(
                                fontSize: 25,
                                fontWeight: FontWeight.w600,
                      ...
                      : ThemeData(
                          ...
                          textTheme: TextTheme(
                            headline5: TextStyle(
                                fontSize: 25.0,
                                fontWeight: FontWeight.w700,
                                color: config.Colors().secondDarkColor(1).withOpacity(1.0),
                                height: 1.35),
                            headline4: TextStyle(
                                fontSize: 15.0,
                                fontWeight: FontWeight.w500,
                            ...
                            headline2: TextStyle(
                                fontSize: 45.0,
                                fontWeight: FontWeight.w600,
                                color: config.Colors().mainDarkColor(1).withOpacity(1.0),
                                height: 1.35),
                            headline1: TextStyle(
                                fontSize: 22.0,
                            ...
                            caption: TextStyle(
                                fontSize: 12.0,
                                color: config.Colors().secondDarkColor(0.6).withOpacity(1.0),
                                height: 1.35),
                          ),
                        ));
            }));
