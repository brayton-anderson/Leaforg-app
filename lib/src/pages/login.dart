...
class LoginWidgetone extends StatefulWidget {
  @override
  _LoginWidgetoneState createState() => _LoginWidgetoneState();
}

class _LoginWidgetoneState extends StateMVC<LoginWidgetone> {
  UserController _con;

  _LoginWidgetoneState() : super(UserController()) {
    _con = controller;
  }
  @override
  void initState() {
