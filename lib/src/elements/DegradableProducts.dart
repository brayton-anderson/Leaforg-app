...
class DegradableProductItemWidget extends StatelessWidget {
  final String heroTag;
  final Product degradable;

  const DegradableProductItemWidget({Key key, this.degradable, this.heroTag})
      : super(key: key);
    ...
    return InkWell(
      ...
      onTap: () {
        Navigator.of(context).pushNamed('/Product',
            arguments: RouteArgument(id: degradable.id, heroTag: this.heroTag));
      },
      child: Container(
        width: 292,
                ...
                children: <Widget>[
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: Helper.getStarsList(degradable.getRate()),
                        ),
                        Text(
                          degradable.extras
                              .map((e) => e.name)
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      degradable.discountPrice > 0
                          ? Helper.getPrice(degradable.discountPrice, context,
