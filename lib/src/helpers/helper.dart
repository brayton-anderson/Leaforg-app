...
//        },
  ...
  static bool canDelivery(Store _store, {List<Cart> carts}) {
    bool _can = true;
    String _unit = setting.value.distanceUnit;
    double _deliveryRange = _store.deliveryRange;
    double _distance = _store.distance;
      ...
      _distance = sqrt(pow(
          ...
          pow(
              69.1 *
                  ...
                  cos(double.parse(_store.latitude) / 57.3),
              2));
    }
    _can &= _store.availableForDelivery &&
