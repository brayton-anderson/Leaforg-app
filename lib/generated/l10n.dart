...
class S {
  ...
  String get select_extras_to_add_them_on_the_product {
    return Intl.message(
      'Select extras to add them on the product',
      name: 'select_extras_to_add_them_on_the_product',
      desc: '',
      args: [],
    );
  }
  ...
  String get deliveryAddressOutsideTheDeliveryRangeOfThisStores {
    return Intl.message(
      'Delivery address outside the delivery range of this stores.',
      name: 'deliveryAddressOutsideTheDeliveryRangeOfThisStores',
      desc: '',
      args: [],
    );
  }

  String get thisStoreNotSupportDeliveryMethod {
    return Intl.message(
      'This store not support delivery method.',
      name: 'thisStoreNotSupportDeliveryMethod',
      desc: '',
      args: [],
    );
  }
